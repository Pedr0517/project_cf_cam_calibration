...
def saveCameraParams(filename, imageSize, cameraMatrix, distCoeffs, totalAvgErr):
    ...
    calibration = {'camera_matrix': cameraMatrix.tolist(
...
parser.add_argument('--imgs', nargs='+', help='list of images for calibration', default=9)
args = parser.parse_args()

sqWidth = 11  # number of squares width
sqHeight = 11  # number of squares height
...
dictionary = cv2.aruco.getPredefinedDictionary(cv2.aruco.DICT_6X6_250)
board = cv2.aruco.CharucoBoard((11, 11), .1, .08, dictionary)
